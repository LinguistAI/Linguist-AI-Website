import { Anchor, Container, List, Paper, Text, Title } from "@mantine/core";
    ...
    <Container size="md" my={40}>
      <Paper shadow="xs" p="md">
        ...
        <List>
          ...
          <List.Item>
            <strong>Application</strong> refers to Linguist, the software
            program provided by the Company.
          </List.Item>
          <List.Item>
            <strong>Company</strong> (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to Linguist.
          </List.Item>
          <List.Item>
            <strong>Country</strong> refers to Turkiye.
          </List.Item>
          <List.Item>
        ...
        <Title order={2}>Collecting and Using Your Personal Data</Title>
        <Title order={3}>Types of Data Collected</Title>
        <Title order={4}>Personal Data</Title>
        <Text>
        ...
        <Title order={4}>Usage Data</Title>
        <Text>
        ...
        <Title order={3}>Use of Your Personal Data</Title>
        <Text>
        ...
        <Title order={3}>Retention of Your Personal Data</Title>
        <Text>
        ...
        <Title order={3}>Transfer of Your Personal Data</Title>
        <Text>
        ...
        <Title order={3}>Delete Your Personal Data</Title>
        <Text>
        ...
        <Title order={3}>Disclosure of Your Personal Data</Title>
        ...
        <Title order={3}>Security of Your Personal Data</Title>
        <Text>
        ...
        <Title order={2}>Usage, Performance and Miscellaneous</Title>
        <Text>
        ...
        <List>
          ...
          <List.Item>
            <Text fw={500}>Amazon Web Services (AWS)</Text>
            <Text>
              Their Privacy Policy can be viewed at{" "}
              <Anchor
        ...
        <Title order={2}>Links to Other Websites</Title>
        ...
        <List>
          <List.Item>By email: linguistai@googlegroups.com</List.Item>
        </List>
      </Paper>
    </Container>
  );
